...
\section{Références}
Pour les profils clients idéaux (ICP), la stratégie marketing d'influence et la stratégie de contenu réseaux sociaux, voir le document séparé : \texttt{ROOGO\_ICP\_BURKINA\_FASO.tex}
